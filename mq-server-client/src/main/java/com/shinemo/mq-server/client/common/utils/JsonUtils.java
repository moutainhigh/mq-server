...
/**
 * CCreated by zhangyan on 15/11/2018.
 */
public abstract class JsonUtils {
    ...
    private final static com.shinemo.mq-server.client.common.utils.JsonUtils jacksonUtils;

    private final static com.shinemo.mq-server.client.common.utils.JsonUtils gsonUtils;
    ...
    static {
        ...
        jacksonUtils = new com.shinemo.mq-server.client.common.utils.JsonUtils() {
            @Override
        ...
        gsonUtils = new com.shinemo.mq-server.client.common.utils.JsonUtils() {
            @Override
            public String toJson(Object object) {
                if (object == null) {
                    return null;
    ...
    public static com.shinemo.mq-server.client.common.utils.JsonUtils getJsonUtils(JsonUtilsType jsonUtilsType) {
