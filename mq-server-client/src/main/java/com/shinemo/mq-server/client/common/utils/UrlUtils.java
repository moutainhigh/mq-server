...
public class UrlUtils {
    ...
    public static class JacksonConvert implements Convert {
        private com.shinemo.mq-server.client.common.utils.JsonUtils jsonUtils = com.shinemo.mq-server.client.common.utils.JsonUtils.getJsonUtils(com.shinemo.mq-server.client.common.utils.JsonUtils.JsonUtilsType.Jackson);

        @Override
        public <Value> String encodeConvert(Value from, String charset) {
            return com.shinemo.mq-server.client.common.utils.UrlUtils.encodeValue(jsonUtils.toJson(from), charset);
        }

        @Override
        public <Value> Value decodeConvert(String from, Class<Value> clazz, String charset) {
            return jsonUtils.fromJson(com.shinemo.mq-server.client.common.utils.UrlUtils.decodeValue(from, charset), clazz);
        }
    }

    public static class GsonConvert implements Convert {
        private com.shinemo.mq-server.client.common.utils.JsonUtils jsonUtils = com.shinemo.mq-server.client.common.utils.JsonUtils.getJsonUtils(com.shinemo.mq-server.client.common.utils.JsonUtils.JsonUtilsType.Gson);
